...
<ul>
    ...
    <c:if test="${ role eq 'administrator'}">
        ...
        <li class="current_page_item"><a href="/jsp/addBook.jsp" accesskey="2" title=""><fmt:message key="add.book" bundle="${ rb }"/></a></li>
...
<form name="addBookForm" method="POST" action="controller">
    <div class="form">
        ...
        <input type="text" name="information" value="" placeholder="<fmt:message key="book.information" bundle="${ rb }"/>"/>
