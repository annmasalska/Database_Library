...
<form name="registrationForm" method="POST" action="controller">
    ...
    <input type="text" class="zocial-dribbble" name="username" value="" placeholder="<fmt:message key="registration.login.placeholder" bundle="${ rb }"/>"/>
    <input type="text" name="idcard" value="" placeholder="<fmt:message key="idcard.placeholder" bundle="${ rb }"/>"/>
    <input type="password" name="pass" value="" placeholder="<fmt:message key="password.placeholder" bundle="${ rb }"/>"/>
    <input type="password" name="pass_repeat" value="" placeholder="<fmt:message key="password.placeholder.repeat" bundle="${ rb }"/>"/>
